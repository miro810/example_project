...
export default function CategoryModal({ session, isVisible, setIsVisible, reRender }: ICategoryProps) {
	...
	return (
		<Modal keepMounted={false} opened={isVisible} onClose={() => setIsVisible(false)} title={'Create new Category:'}>
			<Input placeholder={'Enter new category name:'} type={'text'} value={value} onChange={(e) => setValue(e.target.value)} />
			<Center>
